...
public class ResponseResult<T> implements Serializable {
	...
	private static final long serialVersionUID = -7768721732116197972L;
	...
	public class CodeStatus {
		 ...
		 * 熔断请求
		 */
		public static final int BREAKING = 2004;

		/**
		 * 非法请求
		 */
		public static final int ILLEGAL_REQUEST = 5000;

		/**
		 * 非法令牌
		 */
		public static final int ILLEGAL_TOKEN = 5008;
